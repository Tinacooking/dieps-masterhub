...
export const Services = () => {
  ...
  const services = [
    ...
    { icon: Shield, title: "100% On-Chain Risk Guardians", desc: "Every transaction passes through our deterministic Guardian engine, which queries live Sui RPC nodes for price impact, pool freshness, and supply concentration. Routes are flagged Safe, Warning, or Danger with Danger-level risks blocked by default and requiring explicit user override." },
