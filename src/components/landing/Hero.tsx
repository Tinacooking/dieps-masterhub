        ...
        <div className="w-full md:w-[55%] h-full flex flex-col justify-center px-8 md:px-24 z-10 relative">
          <div className="max-w-[700px]">
            ...
            <div ref={buttonsRef} className="flex items-center gap-6 opacity-0">
              ...
              <button
                onClick={() => window.open("https://diepsprotocol.gitbook.io/diepsprotocol-docs", "_blank")}
                className="px-8 py-4 text-white/70 font-medium tracking-[0.02em] hover:text-white transition-colors duration-300 flex items-center gap-2 cursor-pointer text-[13px] border border-white/10 hover:border-white/30 rounded-xl bg-white/5 hover:bg-white/10 backdrop-blur-sm">
                Read Documentation
              </button>
            </div>
          </div>
